...
app.controller('ProjectController', function($http, metarService, $routeParams){
	...
	self.projects = [
		{"id":"1", "name":"Main Project", "description":"Students will define and develop an information-based" + 
		...
		"meets with the approval of the instructor.", "notifications":["3 Unread Messages",
		...
		{"id":"2", "name":"Research Project", "description":"Select a project that has “significant” " + 
		...
		"notifications":["Research Paper due 5/10/2015"], "team":"Group 3", "numteams":5, 
		"url":"http://www.se.rit.edu/~swen-343/projects/EnterpriseApp/EnterpriseProjectStudentsChoice.html"},
		{"id":"3", "name":"PM Project", "description":
		...
		"accurate plan.", "notifications":[], "team":"Group 1", "numteams":13, 
